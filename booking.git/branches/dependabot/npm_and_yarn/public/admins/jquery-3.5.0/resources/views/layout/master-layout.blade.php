...
<body>
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v4.0&appId=570055446860048&autoLogAppEvents=1"></script>
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v4.0&appId=570055446860048&autoLogAppEvents=1"></script>
...
<header>
    ...
    margin-left: 0.5rem;"></i></a>
        <div class="kho-giao-dien" id="col2" style="display: none;">
            ...
            <a href="./thietkewebtheomau.html">Thiết kế web theo mẫu</a>
            <a href="./thietkewebtheoyeucau.html">Thiết kế web theo yêu cầu</a>
            <a href="./thietkewebchuanseochuyennghiep.html">Thiết kế web chuẩn SEO chuyên nghiệp</a>
            <a href="./thietkewebchuanmobile.html">Thiết kế web chuẩn Mobile</a>
            <a href="./dichvuseowebsite.html">Dịch vụ SEO website</a>
            <a href="./dichvuvietbaichuanseo.html">Dịch vụ viết bài SEO website</a>
            <a href="./thietkewebtrongoigiare.html">Thiết kế web trọn gói giá rẻ</a>
            <a href="./chamsocwebsite.html">Chăm sóc website</a>
            <a href="./hostingchatluongcao.html">Hosting chất lượng cao</a>
            <a href="./domaingiare.html">Domain giá rẻ</a>
        </div>
        <a href="thietkewebsite.html">THIẾT KẾ WEBSITE</a>
        <a href="seo.html">SEO</a>
        <a href="khachhang.html">KHÁCH HÀNG</a>
        <a href="javascript:void(0)" class="nav-link col3">THÊM<i class="fa fa-plus plus" aria-hidden="true" style="
    margin-left: 0.5rem;"></i></a>
        <div class="kho-giao-dien" id="col3" style="display: none;">
            <a href="./gioithieudichvu.html">Giới thiệu dịch vụ</a>
            <a href="./banggiathietkewebsite.html">Bảng giá web trọn gói</a>
            <a href="./tintuc.html">Tin tức</a>
            <a href="./hotrokhachhang.html">Hỗ trợ khách hàng</a>
            <a href="./hinhthucthanhtoan.html">Hình thức thanh toán</a>
            <a href="./tuyendung.html">Tuyển dụng</a>
            <a href="./quuytrinhthietkewebsite.html">Quy trình thiết kế website</a>
            <a href="./dieukienvachinhsach.html">Điều kiện và chính sách</a>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 box col-md-4 woocommerce__list wow bounceInLeft woocommerce__list-img" style="background-image: url(./image/beautiful-glacier-88516.herokuapp.comtrang-chu.png);">
                    <div style="padding-top: 400px;">
                        ...
                        <p class="woocommerce__list-text">
                            <a href="http://beautiful-glacier-88516.herokuapp.com/trang-chu" class="btn btn-warning">
                                <i class="far fa-eye"></i>
                                Dùng thử</a>
                            <a class="btn btn-success" onclick="document.getElementById('id01').style.display='block'">
                                <i class="fas fa-check"></i>
                ...
                <div class="col-12 col-sm-6 box col-md-4 woocommerce__list wow bounceInLeft woocommerce__list-img" style="background-image: url(./../image/5mm.vn.png);">
                    <div style="padding-top: 400px;">
                        <center>
                            <p>Mẫu web bán hàng home Shop chuyên nghiệp giá rẻ</p>
                        </center>
                ...
                <div class="col-12 col-sm-6 box col-md-4 woocommerce__list wow bounceInLeft woocommerce__list-img" style="background-image: url(./../image/khanhnck.github.iowebsite_holuutrangchu.html.png);">
                    <div style="padding-top: 400px;">
                        <center>
                            <p>Mẫu web bán hàng home Shop chuyên nghiệp giá rẻ</p>
                        </center>
                ...
                <div class="col-12 col-sm-6 box col-md-4 woocommerce__list wow bounceInLeft woocommerce__list-img" style="background-image: url(./../image/warm-ridge-81798.herokuapp.com.png);">
                    <div style="padding-top: 400px;">
                        <center>
                            <p>Mẫu web bán hàng home Shop chuyên nghiệp giá rẻ</p>
                        </center>
                ...
                <div class="col-12 col-sm-6 box col-md-4 woocommerce__list wow bounceInLeft woocommerce__list-img" style="background-image: url(./../image/trancongvu.github.io.png);">
                    <div style="padding-top: 400px;">
                        <center>
                            <p>Mẫu web bán hàng home Shop chuyên nghiệp giá rẻ</p>
                        </center>
                ...
                <div class="col-12 col-sm-6 box col-md-4 woocommerce__list wow bounceInLeft woocommerce__list-img" style="background-image: url(./../image/sexxking.herokuapp.com.png);">
                    <div style="padding-top: 400px;">
                        <center>
                            <p>Mẫu web bán hàng home Shop chuyên nghiệp giá rẻ</p>
                        </center>
...
<div id="back-to-top">
    <a href="javascript:void(0)" title="Back to top"><img src="http://thietkewebnhanh247.com/wp-content/themes/thietkewebsite/img/top.png" style="width:35px; height:auto" alt=""></a>
</div>
<!-- Phone -->
