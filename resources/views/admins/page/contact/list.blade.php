                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a href="{{route('view_insert_phong')}}" class="btn btn-success">Thêm liên hệ</a>
                            </div>
                            <div class="box-header">
                                            ...
                                            <td>
                                                ...
                                                <div id="button{{$value->id}}">
                                                    <a class="btn btn-primary" id="edit"
                                                       href="{{ url('admin/contact/view_one_contact/'.$value->id) }}"
                                                       onclick="">Sửa</a>
                                                    <a class="btn btn-danger"
                                                       href="{{ url('admin/contact/delete_contact/'.$value->id) }}"
