                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <a href="{{route('view_insert_phong')}}" class="btn btn-success">Thêm phòng</a>
                        </div>
                        <div class="box-body">
                                    ...
                                    <tr class="odd gradeX" align="center">
                                        ...
                                        <td>
                                            ...
                                            <div id="button{{$value->id}}">
                                                <a class="btn btn-primary" id="edit" href="{{ url('admin/phong/view_one_phong/'.$value->id) }}" onclick="">Sửa</a>
