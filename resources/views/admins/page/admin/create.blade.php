    ...
    <div class="container-fluid">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ Route('view_all_admin') }}"><i class="fa fa-dashboard"></i> Danh sách admin</a></li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <a style="text-align: right;" href="{{route('view_all_admin')}}" class="btn btn-primary">Danh sách</a>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <form action="{{Route('process_insert_admin')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <p>Tên</p>
                                        <input name="name" class="form-control" type="text" placeholder="Tên admin" value="{{ old('name') }}">
                                        {{-- @if ($errors->has('name'))  --}}
